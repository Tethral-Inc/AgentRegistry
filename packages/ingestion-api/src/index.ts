...
import { revealedPreferenceRoute } from './routes/revealed-preference.js';
import { compensationRoute } from './routes/compensation.js';
...
app.use('/api/v1/agent/:identifier/notifications/*', agentAuth);
app.use('/api/v1/agent/:identifier/patterns', agentAuth);
app.use('/api/v1/agent/:identifier/patterns/*', agentAuth);
app.use('/api/v1/agent/:identifier/snapshots', agentAuth);
app.use('/api/v1/agent/:identifier/watches', agentAuth);
app.use('/api/v1/agent/:identifier/watches/*', agentAuth);
...
app.route('/api/v1', baselinesRoute);
...
app.route('/api/v1', patternsRoute);
app.route('/api/v1', snapshotsRoute);
app.route('/api/v1', watchesRoute);
